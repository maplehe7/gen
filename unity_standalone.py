...
def sanitize_html_runtime_support_files(output_dir: Path) -> dict[str, Any]:
    ...
    gamedistribution_stub = """(function () {
  const root = window;
  const noop = function () {};
